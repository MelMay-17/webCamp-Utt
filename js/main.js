(function() {
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		if (document.getElementById('mapa')) {
			var map = L.map('mapa').setView([ 18.415049843756123, -97.34407252906375], 16);

			L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png').addTo(map);

			L.marker([ 18.415049843756123, -97.34407252906375]).addTo(map).bindPopup('WebCAMP 2021').openPopup();
			// .bindTooltip('WebCamp 2021, Boletos ya disponibles')
			// .openTooltip();
		}
	});
